...
class AssistTonePlayer {
    ...
    /// Ensure audio session is configured for max volume playback.
    /// Uses .voicePrompt mode to route to watchOS built-in speaker at full volume.
    ...
    private func generateWAV(frequencies: [Double]) -> Data {
        ...
        for (i, freq) in frequencies.enumerated() {
            ...
            for j in 0..<toneSamples {
                ...
                samples.append(Int16(value * 32700))
            }
